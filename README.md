...
Brainf*** est un language de programmation quelque peu ésotérique désigné par **Urban Müller** en 1992. Le programmes brainfuck ne sont composé que des caractères **+**, **-**, **<**, **>**, **[**, **]**, **.** et **,**.
